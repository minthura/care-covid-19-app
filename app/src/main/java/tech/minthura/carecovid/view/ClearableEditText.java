package tech.minthura.carecovid.view;
 ...
 * </pre>
 */
public class ClearableEditText extends TextInputEditText implements OnTouchListener, OnFocusChangeListener, TextWatcher {
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        setClearIconVisible(!StringUtils.isEmpty(s));
    }
...
//        if (hasFocus) {
//            setClearIconVisible(!StringUtils.isEmpty(getText()));
//        } else {
