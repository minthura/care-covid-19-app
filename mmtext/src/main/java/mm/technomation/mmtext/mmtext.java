...
public class mmtext {
        ...
        for (int i = 0; i < root.getChildCount(); i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (textInputLayout.getHint() != null) {
                    ((TextInputLayout) v).setHint(
                            mmtext.processText(textInputLayout.getHint().toString(), EncodedText, SamsungSafe,
                                    SyllabelBreak));
                }
                if (textInputLayout.getError() != null) {
                    setErrorTextFont(tf, textInputLayout, mmtext.processText(textInputLayout.getError().toString(), EncodedText, SamsungSafe,
                            SyllabelBreak));
                }
            }
    ...
    public static void setErrorTextFont(Typeface tf, TextInputLayout textInputLayout, String errorString) {
